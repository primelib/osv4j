...
projectConfiguration {
    ...
    pom = { pom ->
        ...
        pom.issueManagement {
            system.set("GitHub")
            url.set("https://github.com/primelib/osv4j/issues")
        }
        ...
        pom.scm {
            connection.set("scm:git:git://github.com/primelib/osv4j.git")
            developerConnection.set("scm:git:git://github.com/primelib/osv4j.git")
            url.set("https://github.com/primelib/osv4j")
        }
    }
}
